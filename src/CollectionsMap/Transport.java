...
public abstract class Transport {
    ...
    private static final List<Mechanics> mechanics = new ArrayList<>();
    ...
    public static void addMechanics(Mechanics mechanic) {
    ...
    public String toString() {
        return "Transport " + brand + '\'' +  model + '\'' + " с объемом двигателя "  + engineVolume + '\'';
    }
